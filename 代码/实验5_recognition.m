...
disp('读取选择的图片...')  
select_facepath=strcat('D:\u盘\ddd\人工智能\实验\实验5\orl_faces\s',num2str(select_person_num),'\',num2str(select_img_num),'.pgm');
...
subplot(1,2,2);
imshow(imread(strcat('D:\u盘\ddd\人工智能\实验\实验5\orl_faces\s',num2str(select_predict_label),'\',num2str(1),'.pgm')));
title('匹配的图片');